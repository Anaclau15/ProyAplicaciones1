...
{
    public partial class MatriculaMan02 : Form
    {
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                objMatriculaBE.usuRegistro = clsCredenciales.Usuario;

                if (objMatriculaBL.InsertarMatricula(objMatriculaBE) == true)
                {
        ...
        private void MatriculaMan02_Load(object sender, EventArgs e)
        {
            try
            {
