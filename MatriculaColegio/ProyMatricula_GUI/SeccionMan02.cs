...
{
    public partial class SeccionMan02 : Form
    {
        ...
        private void SeccionMan02_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    objSeccionBE.aforo = txtAforo.Text.Trim();
                    objSeccionBE.turno = txtTurno.Text.Trim();
                    ...
                    objSeccionBE.usuRegistro = clsCredenciales.Usuario;
